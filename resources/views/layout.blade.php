...
.contact-map-style nav {
  margin-top: 10px;
}
.contact-map-style nav a {
  display: block;
  font-size: 15px;
  color: #fff;
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link"  href="/activities">Activities Of The Ministry</a>
            </li>
            <li class="nav-item">
      ...
      <div class="footer-style">
        <div class="publication-style">
          <nav>
            ...
            <a href="./book.html"><i class="fa fa-book"></i> SOP Books</a>
          </nav>
        </div>
        <div class="social-media">
          <nav>
            <a href="https://twitter.com/amateraniro"  target="_blank"><i class="fa fa-twitter"></i></a>
            <a href="https://t.me/Lastcallmessages" target="_blank"><i class="fa fa-telegram"></i></a>
            <a href=""><i class="fa fa-instagram" target="_blank"></i></a>
            <a href="https://www.youtube.com/channel/UCrfUkYxS2sh4Pt-gL7CXBtQ" target="_blank"><i class="fa fa-youtube"></i></a>
            <a href="mailto:onlineamateraniro@gmail.com" target="_blank"><i class="fa fa-envelope"></i></a>
            <a href="https://web.facebook.com/amateraniro.online.9" target="_blank"><i class="fa fa-facebook"></i></a>
          </nav>
        </div>
        <div class="contact-map-style">
          <nav>
            <a href=""> <i class="fa fa-phone"></i>  +250 782799851 </a>
            <a href=""> <i class="fa fa-map-marker"></i>  Kigali, Rwanda</a>
          </nav>
        </div>
        <div class="copright-style">
          <p>2022 - The Last Call Messages all rights reserved</p>
        </div>
      </div>
    </footer>
    <script
