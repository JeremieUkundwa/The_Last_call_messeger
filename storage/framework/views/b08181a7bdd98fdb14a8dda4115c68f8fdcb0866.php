...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(url('css/font-awesome-4.7.0/css/font-awesome.css')); ?>" />
        <!-- bootstrap css -->
        ...
        <link rel="stylesheet" href="<?php echo e(url('css/footer.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('css/header.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('css/archive.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('css/video.css')); ?>">
        <style>
...
/* ================end================== */
  ...
  <?php echo $__env->yieldContent('about-us-css'); ?>;
  <?php echo $__env->yieldContent('activities-css'); ?>;
  <?php echo $__env->yieldContent('contactUs-css'); ?>;
  <?php echo $__env->yieldContent('donate-css'); ?>;
  <?php echo $__env->yieldContent('video-css'); ?>;
  <?php echo $__env->yieldContent('sermony-css'); ?>;
        </style>
    </head>
    <body>
    <header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('home.index')); ?>">Ahabanza</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('home.about')); ?>">Abo turi bo</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"  href="<?php echo e(route('home.activities')); ?>">Gahunda n'ibikorwa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="<?php echo e(route('home.videos')); ?>">Videwo</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="<?php echo e(route('home.contact')); ?>">Twandikire</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="<?php echo e(route('home.donate')); ?>">Dushyigikire</a>
            </li>
          </ul>
          <form class="d-flex">
    ...
    <div>
        <?php echo $__env->yieldContent('homePageMain'); ?>
        <?php echo $__env->yieldContent('about-us'); ?>
        <?php echo $__env->yieldContent('activites of the ministry'); ?>
        <?php echo $__env->yieldContent('contact-section'); ?>
        <?php echo $__env->yieldContent('donate-section'); ?>
        <?php echo $__env->yieldContent('video-section'); ?>
        <?php echo $__env->yieldContent('sermony-section'); ?>
        <?php echo $__env->yieldContent('archive-section'); ?>
...
<?php /**PATH /home/jeremie/Desktop/project/laravel/the_last_call_messeges/resources/views/layout.blade.php ENDPATH**/ ?>