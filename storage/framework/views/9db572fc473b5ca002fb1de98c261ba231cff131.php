<?php $__env->startSection('homePageMain'); ?>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              ...
              src="<?php echo e(url('images/bg-1.jpg')); ?>"
              class="d-block w-100"
              alt="..."
            />
          </div>
          <div class="carousel-item">
            <img
              class="home-image-cara"
              src="<?php echo e(url('images/bg-2.jpg')); ?>"
              class="d-block w-100"
              alt="..."
            />
          </div>
          <div class="carousel-item">
            <img
              class="home-image-cara"
              src="<?php echo e(url('images/bg-3.jpeg')); ?>"
              class="d-block w-100"
              alt="..."
            />
          </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jeremie/Desktop/project/laravel/the_last_call_messeges/resources/views/homePage.blade.php ENDPATH**/ ?>